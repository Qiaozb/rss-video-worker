...
find "$APP_DIR/remotion/public/generated" -type f -name "*.wav" -mtime +"$AUDIO_RETENTION_DAYS" -delete 2>/dev/null || true

find "$APP_DIR/output" -type d -empty -delete 2>/dev/null || true
find "$APP_DIR/remotion/public/generated" -type d -empty -delete 2>/dev/null || true
